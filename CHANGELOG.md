...
- **AI "Backbone" Generation**: AI generates the structure (Headings, Sections, Bullet points) based on a topic, and *you* fill in the key details.
    - *Goal: Stop wasting time on setup/formatting, focus purely on the content.*
